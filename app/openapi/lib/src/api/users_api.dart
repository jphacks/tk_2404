...
class UsersApi {
  ...
  Future<Response<JsonObject>> deleteUserApiUsersUidDelete({ 
    required String uid,
    ...
    final _path = r'/api/users/{uid}'.replaceAll('{' r'uid' '}', encodeQueryParameter(_serializers, uid, const FullType(String)).toString());
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserProfile>> getUserProfileApiUsersUidGet({ 
    required String uid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserInfo>> updateUserInfoApiUsersMePut({ 
  ...
  /// Returns a [Future] containing a [Response] with a [UserInfo] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserInfo>> userMeApiUsersMeGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
