...
class SpotifyApi {
  ...
  const SpotifyApi(this._dio, this._serializers);
  ...
  Future<Response<JsonObject>> spotifyCallbackApiSpotifyCallbackGet({ 
    String? code,
    ...
    final _path = r'/api/spotify/callback';
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> spotifyLoginApiSpotifyLoginGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/spotify/login';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
