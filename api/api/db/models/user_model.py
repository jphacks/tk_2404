...
class UserModel(Base):
    ...
    live_area: Mapped[String] = mapped_column(String(length=32), default=None, nullable=True)
    profile_text: Mapped[String] = mapped_column(String(length=64), default=None, nullable=True)
