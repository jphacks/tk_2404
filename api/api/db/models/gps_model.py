...
from sqlalchemy.sql.sqltypes import String, Integer, DOUBLE_PRECISION
...
class GpsModel(Base):
    ...
    gps_id:Mapped[Integer] = mapped_column(Integer, primary_key=True, autoincrement=True)
    ...
    longitude:Mapped[DOUBLE_PRECISION] = mapped_column(DOUBLE_PRECISION, nullable=False)
